        ...
        <div ref={rightRef} style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16, marginBottom: 48 }}>
          {contacts.map((c, i) => (
            <a
              ...
              style={{ display: "flex", alignItems: "center", gap: 16, padding: "22px 24px", borderRadius: 16, border: "1px solid rgba(75,46,43,0.1)", backgroundColor: "rgba(192,133,82,0.03)", textDecoration: "none", transition: "all 0.3s ease" }}>
